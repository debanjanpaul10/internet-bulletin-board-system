  ...
  useEffect(() => {
    if (accounts.length > 0) {
      setShowEditAndDelete(
        post.postOwnerUserName == accounts[0].idTokenClaims?.extension_UserName
      );
                ...
                <div className={styles.headerButtons}>
                  ...
                  {showEditAndDelete && isUserLoggedIn && (
                    <>
                      ...
                      <Tooltip
                        content={ButtonText.DeleteButtonTooltipText}
                        relationship="label"
                      >
                        <Button
          ...
          <CardPreview className={styles.cardPreview}>
            <Body2>
              ...
              {isTextOverflowing && !showFullText && (
                <Button className={styles.button} onClick={handleToggleText}>
                  Show More
                </Button>
              )}
              {showFullText && (
