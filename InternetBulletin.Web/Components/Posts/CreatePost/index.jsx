...
function CreatePostComponent() {
  ...
  const handleCreatePost = async (event) => {
    ...
    errors.Content = postData.Content === "" ? validations.ContentRequired : "";
    setErrors({ ...errors });
  ...
  const handleAiRewrite = () => {
    const strippedContent = postData.Content.replace(/<[^>]*>?/gm, "").trim();
    if (strippedContent !== "") {
                ...
                <div className="col sm-12 mb-3 mb-sm-0">
                  <div className="row p-2">
                    <input
                      ...
                      id="Title"
                      placeholder={
                        CreatePostPageConstants.Headings.TitleBarPlaceholder
                      }
                    />
                    {errors.Title && (
              ...
              <div className="form-group row mt-3">
                <div className="col sm-12 mb-3 mb-sm-0 p-3">
                  <ReactQuill
                    ...
                    placeholder={
                      CreatePostPageConstants.Headings.ContentBoxPlaceholder
                    }
                    modules={modules}
                  />
                  {errors.Content && (
                  ...
                  >
                    <img src={AiButton} style={{ height: "20px" }} /> Rewrite
                    with AI
                  </Button>
                </div>
