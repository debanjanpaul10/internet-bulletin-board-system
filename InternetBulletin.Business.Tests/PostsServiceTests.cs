...
namespace InternetBulletin.UnitTests
{
    ...
    public class PostsServiceTests
    {
        ...
        public async Task GetPostAsync_ShouldThrowException_WhenPostIdIsNullOrEmpty()
        {
            ...
            // Act
            var result = await Assert.ThrowsAsync<Exception>(() => _postsService.GetPostAsync(postId, UserName));
        ...
        public async Task GetPostAsync_ShouldThrowException_WhenPostNotFound()
        {
            ...
            _mockPostsDataService.Setup(x => x.GetPostAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<bool>())).ReturnsAsync(mockEmptyPost);
        ...
        {
            // Arrange
            var expectedPost = TestsHelper.CreateMockPostEntityData(UserName);
            var postId = expectedPost.PostId;
            _mockPostsDataService.Setup(x => x.GetPostAsync(It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<bool>())).ReturnsAsync(expectedPost);

            // Act
            var result = await _postsService.GetPostAsync(postId.ToString(), UserName);
        ...
        public async Task AddNewPostAsync_ShouldThrowArgumentNullException_WhenNewPostIsNull()
        {
            ...
            // Act
            var result = await Assert.ThrowsAsync<Exception>(() => _postsService.AddNewPostAsync(newPost, UserName));
        ...
        public async Task AddNewPostAsync_ShouldReturnTrue_WhenPostIsAddedSuccessfully()
        {
            ...
            _mockPostsDataService.Setup(x => x.AddNewPostAsync(It.IsAny<AddPostDTO>(), It.IsAny<string>())).ReturnsAsync(true);

            // Act
            var result = await _postsService.AddNewPostAsync(mockPost, UserName);
        ...
        public async Task AddNewPostAsync_ShouldReturnFalse_WhenPostIsNotAdded()
        {
            // Arrange
            var mockPost = TestsHelper.CreateMockPostDtoData();
            _mockPostsDataService.Setup(x => x.AddNewPostAsync(It.IsAny<AddPostDTO>(), It.IsAny<string>())).ReturnsAsync(false);
        ...
        {
            // Arrange
            UpdatePostDTO mockPost = null!;

            // Act
            var result = await Assert.ThrowsAsync<Exception>(() => _postsService.UpdatePostAsync(mockPost, UserName));
        ...
        {
            // Arrange
            var mockPost = TestsHelper.CreateMockUpdatePostsDto();
            _mockPostsDataService.Setup(x => x.UpdatePostAsync(It.IsAny<UpdatePostDTO>(), It.IsAny<string>()));

            // Act
            var result = await _postsService.UpdatePostAsync(mockPost, UserName);
        ...
        public async Task DeletePostAsync_ShouldThrowException_WhenPostIdIsNullOrEmpty()
        {
            ...
            // Act & Assert
            var exception = await Assert.ThrowsAsync<Exception>(() => _postsService.DeletePostAsync(postId, UserName));
        ...
        public async Task DeletePostAsync_ShouldReturnTrue_WhenPostIsDeletedSuccessfully()
        {
            ...
            _mockPostsDataService.Setup(x => x.DeletePostAsync(It.IsAny<Guid>(), It.IsAny<string>())).ReturnsAsync(true);

            // Act
            var result = await _postsService.DeletePostAsync(postId, UserName);
        ...
        public async Task DeletePostAsync_ShouldReturnFalse_WhenPostIsNotDeleted()
        {
            // Arrange
            var postId = Guid.NewGuid().ToString();
            _mockPostsDataService.Setup(x => x.DeletePostAsync(It.IsAny<Guid>(), It.IsAny<string>())).ReturnsAsync(false);
        ...
        {
            // Arrange
            var mockPostsList = TestsHelper.CreateMockListPostEntityData(UserName);
