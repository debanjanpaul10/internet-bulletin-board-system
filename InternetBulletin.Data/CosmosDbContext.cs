...
namespace InternetBulletin.Data
{
    ...
    public class CosmosDbContext : DbContext
    {
        ...
        {
            modelBuilder.HasDefaultContainer(ConfigurationConstants.PostsContainerConstant);
            modelBuilder.Entity<Post>().HasNoDiscriminator().HasPartitionKey(c => c.PostId).HasKey(c => c.PostId);
        }
    }
}
