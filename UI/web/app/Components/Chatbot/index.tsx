...
import { GetChatbotResponseAsync } from "@store/AiServices/Actions";
...
import FollowupQuestionsComponent from "@components/Chatbot/Components/FollowupQuestions";
...
export default function ChatbotComponent() {
	...
	// const renderFollowupQuestionsContainer = () => {
	// 	return (
	// 		<>
	// 			{lastBotMessage &&
	// 				showFollowups &&
	...
	const renderChatContainer = () => {
		return (
			<div className={styles.chatContent}>
				...
				{/* FOLLOWUP QUESTIONS */}
				{/* {renderFollowupQuestionsContainer()} */}
