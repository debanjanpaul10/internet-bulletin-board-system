...
export const TOGGLE_VOTING_LOADER = "TOGGLE_VOTING_LOADER";
export const TOGGLE_EDIT_POST_DIALOG = "TOGGLE_EDIT_POST_DIALOG";
export const GET_EDIT_POST_DATA = "GET_EDIT_POST_DATA";

export const TOGGLE_EDIT_POST_LOADER = "TOGGLE_EDIT_POST_LOADER";
